...
class Ship:
    ...
    def get_nose_position(self):
        nose = self.rotate_point([0, -20], self.angle)
        return [self.position[0] + nose[0], self.position[1] + nose[1]]
    ...
    def draw_debug(self):
        if DEBUG:
            ...
            DrawCircle(int(self.position[0]), int(self.position[1]), self.radius, RED)